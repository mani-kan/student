...
.button:hover{
  ...
  color: azure;
    ...
    <body>
        ...
        <div class="marquee"> <marquee bgcolor="light green" width="100%" loop="-1" scrollamount="10" > <font color="white" face="Times New Roman"> CHECK YOUR CURRENT MID RESULTS AS WILL AS PREFINAL RESULTS </font>  </marquee> </div>
        ...
        <center>
        <table border=1>
	<form action="midresult.php" method="post">
...
if(isset($_POST['hallticket']) && isset($_POST['semester'])) {
    ...
    $resultQuery = "SELECT subjects.subject_name, midresults.marks, semester.sem_name
                    FROM midresults
                    INNER JOIN subjects ON midresults.subject_name = subjects.subject_name
                    INNER JOIN semester ON midresults.sem_name = semester.sem_name
                    WHERE midresults.hall_ticket_number = '$hallticket' AND midresults.sem_name = '$semester'";
